...
# Tags & Scheduling
TAG_NAME = ["PIC:DevOps", "Src:ora-dwhdb-sec", "Des:lakehouse-raw.dwh", "Todo:NONE"]
startDate = datetime(year=2025, month=9, day=1)
cron_regex = "30 22 * * *"  # daily 22h30

# Config
git_repo_url = "git@repository.centralretail.com.vn:platform/automation/spark.git"
JOB_PATH = "/opt/spark/prd/dwh"
...
TABLE_NAME = [
    ...
    "ADM.ADM_NOTCOMP",
    "CMS.SITEMAPPOS",
    "DWHBO.BI_INF_BDV_BUDGETVERSION"
]

# DAG
with DAG(
    dag_id="spark-dwh-lakehouse-2230",
